      ...
      <?php foreach ($productos as $prod):?>
        <tr>
          ...
          <td>
            ...
            <?php if($prod['soft_delete']): ?>
              <a href="<?= base_url('/productos/restaurar/' . $prod['id_producto'])?>" class="btn btn-success">Restaurar <i class="fa fa-retweet" aria-hidden="true"></i></a>
            <?php endif; ?>
          </td>
        </tr>
      <?php endforeach;?>
