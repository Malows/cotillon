...
<div class="col-xm-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 well">
  ...
  <div class="alert alert-block alert-success">
    <button type="button" class="close" data-dismiss="alert">&times;</button>
          <h4>Genial!</h4>
          Se ha agregado exitosamente la categoria de productos <strong>'.$categoria.
      '</div>';
  }
  echo form_open("/categorias/crear")?>
    <div class="form-group">
        <label for="nombre_categoria">Nombre de categoria<?php echo form_error("nombre_categoria");?></label>
        <input type="text" class="form-control" name="nombre_categoria" placeholder="Nombre de categoria">
