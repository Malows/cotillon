  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <?php if($prov['soft_delete']): ?>
          <a href="<?= base_url('/proveedores/restaurar/' . $prov['id_proveedor'])?>" class="btn btn-success">Restaurar <i class="fa fa-retweet" aria-hidden="true"></i></a>
        <?php endif; ?>
      </td>
